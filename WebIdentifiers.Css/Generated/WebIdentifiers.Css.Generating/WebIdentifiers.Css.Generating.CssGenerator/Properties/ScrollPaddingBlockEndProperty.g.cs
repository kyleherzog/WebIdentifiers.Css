...
/// <summary>
/// Provides a CSS entry for the ScrollPaddingBlockEnd property.
/// </summary>
public partial class ScrollPaddingBlockEndProperty : CssPropertyEntry
{
	/// <summary>
	/// Represents a scroll-padding-block-end CSS property entry.
	/// </summary>
	/// <param name="value">An optional value with which to initialize the CSS property entry.</param>
	public ScrollPaddingBlockEndProperty(string? value = null)
		: base(CssPropertyNames.ScrollPaddingBlockEnd, value)
	{
	}
	...
	/// </summary>
	public ScrollPaddingBlockEndProperty SetToAuto()
	{
