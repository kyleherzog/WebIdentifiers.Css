...
/// <summary>
/// Provides a CSS entry for the ScrollPaddingBlock property.
/// </summary>
public partial class ScrollPaddingBlockProperty : CssPropertyEntry
{
	/// <summary>
	/// Represents a scroll-padding-block CSS property entry.
	/// </summary>
	/// <param name="value">An optional value with which to initialize the CSS property entry.</param>
	public ScrollPaddingBlockProperty(string? value = null)
		: base(CssPropertyNames.ScrollPaddingBlock, value)
	{
	}
	...
	/// </summary>
	public ScrollPaddingBlockProperty SetToAuto()
	{
