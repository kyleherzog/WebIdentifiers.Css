...
/// <summary>
/// Provides a CSS entry for the ContainIntrinsicWidth property.
/// </summary>
public partial class ContainIntrinsicWidthProperty : CssPropertyEntry
{
	/// <summary>
	/// Represents a contain-intrinsic-width CSS property entry.
	/// </summary>
	/// <param name="value">An optional value with which to initialize the CSS property entry.</param>
	public ContainIntrinsicWidthProperty(string? value = null)
		: base(CssPropertyNames.ContainIntrinsicWidth, value)
	{
	}
	...
	/// </summary>
	public ContainIntrinsicWidthProperty SetToAuto()
	{
	...
	/// </summary>
	public ContainIntrinsicWidthProperty SetToNone()
	{
