...
/// <summary>
/// Provides a CSS entry for the ScrollPaddingInlineStart property.
/// </summary>
public partial class ScrollPaddingInlineStartProperty : CssPropertyEntry
{
	/// <summary>
	/// Represents a scroll-padding-inline-start CSS property entry.
	/// </summary>
	/// <param name="value">An optional value with which to initialize the CSS property entry.</param>
	public ScrollPaddingInlineStartProperty(string? value = null)
		: base(CssPropertyNames.ScrollPaddingInlineStart, value)
	{
	}
	...
	/// </summary>
	public ScrollPaddingInlineStartProperty SetToAuto()
	{
