...
/// <summary>
/// Provides a CSS entry for the ScrollPadding property.
/// </summary>
public partial class ScrollPaddingProperty : CssPropertyEntry
{
	/// <summary>
	/// Represents a scroll-padding CSS property entry.
	/// </summary>
	/// <param name="value">An optional value with which to initialize the CSS property entry.</param>
	public ScrollPaddingProperty(string? value = null)
		: base(CssPropertyNames.ScrollPadding, value)
	{
	}
	...
	/// </summary>
	public ScrollPaddingProperty SetToAuto()
	{
