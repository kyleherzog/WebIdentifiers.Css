...
/// <summary>
/// Provides a CSS entry for the ScrollPaddingInline property.
/// </summary>
public partial class ScrollPaddingInlineProperty : CssPropertyEntry
{
	/// <summary>
	/// Represents a scroll-padding-inline CSS property entry.
	/// </summary>
	/// <param name="value">An optional value with which to initialize the CSS property entry.</param>
	public ScrollPaddingInlineProperty(string? value = null)
		: base(CssPropertyNames.ScrollPaddingInline, value)
	{
	}
	...
	/// </summary>
	public ScrollPaddingInlineProperty SetToAuto()
	{
