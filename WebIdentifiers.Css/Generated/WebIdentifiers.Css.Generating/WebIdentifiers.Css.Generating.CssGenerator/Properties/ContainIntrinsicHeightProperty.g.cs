...
/// <summary>
/// Provides a CSS entry for the ContainIntrinsicHeight property.
/// </summary>
public partial class ContainIntrinsicHeightProperty : CssPropertyEntry
{
	/// <summary>
	/// Represents a contain-intrinsic-height CSS property entry.
	/// </summary>
	/// <param name="value">An optional value with which to initialize the CSS property entry.</param>
	public ContainIntrinsicHeightProperty(string? value = null)
		: base(CssPropertyNames.ContainIntrinsicHeight, value)
	{
	}
	...
	/// </summary>
	public ContainIntrinsicHeightProperty SetToAuto()
	{
	...
	/// </summary>
	public ContainIntrinsicHeightProperty SetToNone()
	{
